...
@section('konten')
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Edit Data Pelamar Masuk</h4>
                <p class="card-description">
                </p>
                <form action="/updatedatapelamar/{{ $data->id }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="pathFile" value="{{ $data->fotopelamar }}">
                        <div class="input-group col-xs-12">
                            <input type="text" class="form-control file-upload-info" disabled
                                placeholder="{{ $data->fotopelamar }}">

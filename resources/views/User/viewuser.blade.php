...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <a href="/inputuser" class="btn btn-secondary btn-sm"><i class="fa fa-pencil"></i>&nbsp;Input</a>
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th>
                                <center>
                                    <a href="/edituser/{{$x->id}}" class="btn btn-secondary btn-sm"><i class="fa fa-pencil"></i>&nbsp;Edit</a>

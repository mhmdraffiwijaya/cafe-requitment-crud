...
@section('konten')
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Input Data Daftar Lamaran</h4>
                <p class="card-description">
                </p>
                <form action="/savedatadaftarpelamar" method="POST" class="form-horizontal" files="true"
                    ...
                    <input type="hidden" name="Tidak Diterima" class="form-control" value="{{ auth()->user()->name }}">

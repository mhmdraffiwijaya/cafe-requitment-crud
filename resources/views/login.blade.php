...
<head>
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="{{asset('Admin/images/logocafe.png')}}">
</head>
                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <div class="brand-logo">
                                <center>
                                    <a href="home" target="blank"><img src="Admin/images/logocafe.png" alt="logo"></a>
                                </center>
                            </div>
                            <center>
                                <h4 class="font-weight-light">Silakan Login Terlebih Dahulu</h4>
                            </center>
